					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							<div class="card-header">
								<h5 style="display:inline-block; ">Edit Skill</h5>
							</div>	
							<!-- form start -->
                            <div class="container mt-2 mb-3">
                                <form action="<?= base_url('skill/edit');?>" method="post">
                                    <input name="id" type="hidden" class="form-control"  value="<?php echo $skill->id ?>">
                                    <div class="form-group">
                                        <label>Nama Lengkap</label>
                                        <input name="judul" type="text" class="form-control"  value="<?php echo $skill->judul ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="persentase" type="text" class="form-control"  value="<?php echo $skill->persentase ?>">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        <label>TTL</label>
                                        <input name="warna" type="text" class="form-control" value="<?php echo $skill->warna ?>">
                                        <div class="invalid-feedback">
