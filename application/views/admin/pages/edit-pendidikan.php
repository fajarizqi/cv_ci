					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="card">
							<div class="card-header">
								<h5 style="display:inline-block; ">Edit PEndidikan</h5>
							</div>	
							<!-- form start -->
                            <div class="container mt-2 mb-3">
                                <form action="<?= base_url('pendidikan/edit');?>" method="post">
                                    <input name="id" type="hidden" class="form-control"  value="<?php echo $pendidikan->id ?>">
                                    <div class="form-group">
                                        <label>Nama Lengkap</label>
                                        <input name="judul" type="text" class="form-control"  value="<?php echo $pendidikan->judul ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="tahun" type="text" class="form-control"  value="<?php echo $pendidikan->tahun ?>">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        <label>TTL</label>
                                        <input name="ket" type="text" class="form-control" value="<?php echo $pendidikan->keterangan ?>">
                                        <div class="invalid-feedback">
